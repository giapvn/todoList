(function($){
	...
	function toDoFeature(){
		...
		var $buttonDeleteATask = $listTasks.find('button');
		var $checkboxDoneATask = $listTasks.find(':checkbox');
		var KEY_ENTER = 13;


		$buttonDeleteATask.on('click',toTriggerDeleteTask);
		$checkboxDoneATask.on('click',doneTask);
